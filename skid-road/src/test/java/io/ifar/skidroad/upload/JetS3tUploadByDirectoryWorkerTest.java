...
public class JetS3tUploadByDirectoryWorkerTest {
    ...
    public void testDetermineArchiveURI() throws URISyntaxException {
        ...
        JetS3tUploadByDirectoryWorker worker = new JetS3tUploadByDirectoryWorker(logFile, null, new URI("s3://my_bucket/prefix"), null);
    ...
    public void testDetermineArchiveGroup() {
        LogFile logFile = new LogFile();
        logFile.setPrepPath(new File("/var/skid_road_logs/environment_foo/my_project_2013-10-07T21-33_1.gz.aes-sic").toPath());
        JetS3tUploadByDirectoryWorker worker = new JetS3tUploadByDirectoryWorker(logFile, null, null, null);
